...
export default async function ProductDetail({ params }) {
  ...
  return (
    <>
      <Header />
      <main className="px-32 pt-8 pb-3 grid grid-cols-3 gap-12 h-full">
        <aside>
        ...
        <div className="sticky top-20 flex flex-col h-fit border border-slate-400 rounded-xl p-3 mx-8">
